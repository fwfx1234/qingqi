...
pub use crate::features::api_debugger::model::{
    ...
    pub fn send_request(
        ...
        thread::spawn(move || {
            ...
            if !tid.is_empty() {
                ...
                let tab = crate::features::api_debugger::model::HttpTab {
                    id: tid.clone(),
...
fn env_ui_to_full(env: &ApiEnvironment, id: &str) -> EnvironmentFull {
    EnvironmentFull {
        env: crate::features::api_debugger::model::Environment {
            id: id.to_string(),
            name: env.name.clone(),
...
mod tests {
    ...
    fn script_assertion_results_in_response() {
        use crate::features::api_debugger::script_service;
