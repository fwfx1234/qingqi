...
use windows::{
    ...
    Win32::UI::WindowsAndMessaging::{
        ...
        LLKHF_ALTDOWN, PostQuitMessage, SetWindowsHookExW, UnhookWindowsHookEx,
...
static HOOK_CTX: std::sync::atomic::AtomicUsize =
...
fn install_hook(
    ...
    let ctx = Box::new(HookContext { entries, sender: tx });
