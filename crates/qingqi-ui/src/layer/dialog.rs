...
impl Dialog {
    ...
    pub fn max_width(mut self, w: Pixels) -> Self {
    ...
    pub fn overlay_closable(mut self, c: bool) -> Self {
        self.overlay_closable = c;
        self
    }
    ...
    pub fn primary_button(
        ...
        on_click: impl Fn(&ClickEvent, &mut Window, &mut App) -> bool + 'static,
    ) -> Self {
        self.primary_button = Some(DialogButton {
            label: label.into(),
    ...
    pub fn secondary_button(
        ...
        self.secondary_button = Some(DialogButton {
            label: label.into(),
        ...
        let overlay = if self.overlay {
            ...
            if self.overlay_closable {
                if let Some(on_close) = &self.on_close {
                    ...
                    overlay
                        .interactivity()
                        .on_click(move |e, w, cx| on_close(e, w, cx));
                }
            }
            overlay
        } else {
