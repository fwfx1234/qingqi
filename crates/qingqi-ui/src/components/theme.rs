...
impl Theme {
    ...
    #[inline(always)]
    pub fn global(cx: &App) -> Self { tokens(cx) }

    #[inline(always)]
    pub fn global_mut(cx: &mut App) -> Self { tokens(cx) }
}
...
impl ActiveTheme for App {
    #[inline(always)]
    fn theme(&self) -> Token { tokens(self) }
}
...
impl ThemeMode {
    pub fn is_dark(&self) -> bool { matches!(self, ThemeMode::Dark) }
}
