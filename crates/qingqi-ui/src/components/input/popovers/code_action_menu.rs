...
use gpui::{App, Context, Entity, IntoElement, Render, Window, div, prelude::FluentBuilder as _};
...
impl CodeActionMenu {
    ...
    pub fn show(&mut self, _cursor: usize, _items: Vec<CodeActionItem>, _window: &mut Window, _cx: &mut Context<Self>) {
        self.is_open = true;
    }
