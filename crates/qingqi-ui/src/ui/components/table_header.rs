...
pub fn table_header_cell(label: impl Into<SharedString>, width: f32, cx: &App) -> impl IntoElement {
...
pub fn table_header_flex(label: impl Into<SharedString>, grow: f32, cx: &App) -> impl IntoElement {
    let label = label.into();
    let cell = div()
        .h(px(30.0))
        .px_2()
